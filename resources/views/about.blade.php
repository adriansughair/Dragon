...
@section('content')
    ...
    <!-- ======= Intro Single ======= -->
    <section class="intro-single py-4">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about-img-box">
                        <img src="https://www.kindpng.com/picc/m/144-1447252_group-vector-user-add-user-icon-png-transparent.png"
                            alt="" class="img-fluid">
                    </div>
                    <div class="sinse-box">
                        <h3 class="sinse-title">Dragon-RE
                            <span></span>
                            <br> Sinse 2017
                        </h3>
                        <p>Art & Creative</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card-box-d">
                        <div class="card-img-d">
                            <img src="https://cdn.pixabay.com/photo/2014/03/25/16/24/female-296989__340.png" alt=""
